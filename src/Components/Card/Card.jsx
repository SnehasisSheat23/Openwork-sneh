...
function Card({ img, text }) {
    return (
        <>
            <div className="h-[55vh] w-64 min-w-64 hover:scale-105 duration-300 rounded-lg relative mt-3 cursor-pointer bg-black border-none">
                ...
                <div className="absolute z-10 bottom-2 w-full flex gap-3 px-5">
