...
function Festivalsection() {
    ...
    useEffect(() => {
        ...
        // Re-check scrollability after delays to ensure content and images are rendered
    ...
    return (
        <div className="relative w-full bg-gradient-to-b from-black via-black/50 to-transparent flex justify-center pt-8">
            <div className="w-full max-w-[1440px] flex flex-col px-4 py-4 sm:px-6 md:px-10 lg:px-20 xl:px-32 lg:py-8 ">
                <div className={`w-full h-10 flex ${!isScrollable ? 'justify-center' : 'justify-between'} items-center `}>
                    <h1 className={`text-white font-bold text-3xl md:text-4xl ${!isScrollable ? 'text-center' : 'text-center md:text-left'} w-full md:w-auto`}>
                        Upcoming Tours
                    </h1>
                    ...
                    {isScrollable && (
                        <div className="hidden md:flex h-full items-center gap-5">
                            ...
                            {/* Calendar button - commented out for now, may be needed in the future */}
                            {/* <button
                ...
                <div className="w-full h-[560px]  flex items-center justify-center">
                    <div
                        ref={scrollRef}
                        className={`flex h-[480px] gap-3 overflow-x-auto snap-x snap-mandatory scroll-smooth scrollbar-hide w-full max-w-full box-border ${!isScrollable ? 'justify-center' : ''}`}
                    >
