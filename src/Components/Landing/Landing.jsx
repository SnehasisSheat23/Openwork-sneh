function Landing() {
    return (
        <>
            <div
                className="relative flex justify-center items-center h-[90vh] w-full bg-no-repeat bg-cover"
            ...
            >
                ...
                <div className="relative flex flex-col items-center text-center gap-4 px-4">
                    ...
                    <div className="h-10 text-[10px] sm:text-[12px] cursor-pointer font-semibold text-white border-[2px] border-white flex justify-center items-center w-28 sm:w-32 rounded-2xl">
                        TIMETABLE
                    </div>
                </div>
            </div>
