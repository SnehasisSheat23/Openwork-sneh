function Highlights() {
    return (
        <>
            <div className="w-full h-auto flex flex-col bg-[#3d2c2c] py-8 ">
                <div className="w-full max-w-screen-2xl h-[80px] box-border flex justify-between px-6 xl:px-32 lg:px-20 irtems-center mx-auto">
    ...
    <p>Gallery</p>
                ...
                <div className="w-full flex flex-col lg:flex-row gap-7 px-6 lg:px-20 items-center lg:justify-center mt-6 cursor-pointer">
                    ...
                    <div className="h-[300px] lg:h-[365px] w-full lg:w-72 bg-black rounded-2xl shadow-lg  bg-[url('https://cdn.britannica.com/40/147140-050-63A7ED5B/dancing-Garba-festival-Navratri-Ahmadabad-India-Gujarat.jpg')] bg-cover bg-center hover:scale-105 duration-300"></div>

                    <div className="h-[300px] lg:h-[370px] w-full lg:w-72 bg-black rounded-2xl overflow-hidden shadow-lg hover:scale-105 duration-300">
                        <div className="h-1/2">
                            <img
                ...
                <div className="w-full flex flex-col lg:flex-row gap-6 px-6 lg:px-20 items-center lg:justify-center mt-9 cursor-pointer">
                    <div className="h-[300px] lg:h-[370px]  w-full lg:w-72 bg-black rounded-2xl shadow-lg bg-[url('https://scontent.fccu18-1.fna.fbcdn.net/v/t39.30808-6/424585509_914261147377604_414227692603225998_n.jpg?_nc_cat=111&ccb=1-7&_nc_sid=127cfc&_nc_ohc=2Q7l7RGVZa4Q7kNvgF1L0lT&_nc_ht=scontent.fccu18-1.fna&_nc_gid=Ak1yTz5Es4E3QBUo5WddTSa&oh=00_AYDD7JUE_Vj8Kbf1L-Nkqgk2FpcCFCLKJJYsomEraW1jew&oe=66FA28FA')] bg-cover bg-center hover:scale-105 duration-300"></div>

                    <div className="h-[300px] lg:h-[370px] w-full lg:w-[570px] bg-black flex flex-col lg:flex-row rounded-2xl shadow-lg hover:scale-105 duration-300">
