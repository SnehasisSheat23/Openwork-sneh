        ...
        <footer className="bg-[#3d2c2c] text-white  w-full box-border">
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div>
                        <h3 className="text-lg font-semibold mb-4">Tomorrowland Belgium</h3>
                        <ul>
